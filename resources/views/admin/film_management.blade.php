    ...
    <div class="col-12">
        <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
            ...
            <div class="d-flex gap-2">
                <button class="btn btn-primary" type="button" data-bs-toggle="modal" data-bs-target="#movieCreateModal">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-hover align-middle" style="min-width: 980px;">
                        ...
                        @php
                            $demoMovies = [
                                [
                                    ...
                                    'language' => 'Tiếng Anh',
                                    'subtitle' => 'Có',
                                    'description' => 'Demo mô tả phim Avatar 2',
                                    'director' => 'Demo Director 1',
                                ...
                                [
                                    ...
                                    'language' => 'Tiếng Anh',
                                    'subtitle' => 'Có',
                                    'description' => 'Demo mô tả phim Dune Part Two',
                        ...
                        @foreach($demoMovies as $i => $m)
                            <tr>
                                <td>{{ $i + 1 }}</td>
                                <td>
                                    <img src="{{ asset('assets/movies/'.$m['poster']) }}" alt="poster" style="width: 48px; height: 68px; object-fit: cover; border-radius: 6px; background:#eee;">
                                </td>
                                <td>
                                    <div class="fw-semibold">{{ $m['title'] }}</div>
                                </td>
                                <td class="text-muted">{{ $m['release'] }}</td>
                                <td class="text-muted">{{ $m['duration'] }}</td>
                                <td>
                                    @php
                                        $badgeClass = 'text-bg-secondary';
                                        if ($m['status'] === 'Đang chiếu') $badgeClass = 'text-bg-success';
                                        if ($m['status'] === 'Sắp chiếu') $badgeClass = 'text-bg-primary';
                                        if ($m['status'] === 'Ngừng chiếu') $badgeClass = 'text-bg-danger';
                                    @endphp
                                    <span class="badge {{ $badgeClass }}">{{ $m['status'] }}</span>
                                </td>
                                <td class="text-muted">{{ $m['genres'] }} • {{ $m['age'] }}</td>
                                <td class="text-muted">{{ $m['language'] }} • {{ $m['subtitle'] }}</td>
                                <td>
                                    <div class="d-flex gap-2 flex-wrap">
                                        <button
                                            ...
                                            data-bs-target="#movieUpdateModal"
                                        >
                                        ...
                                        <button
                                            ...
                                            data-bs-toggle="modal"
                                            data-bs-target="#movieClassifyModal"
                                        >
                                        ...
                                        <button
                                            ...
                                            data-bs-toggle="modal"
                                            data-bs-target="#movieToggleModal"
                                        >
                                            <i class="bi bi-eye-slash"></i> Ẩn/Ngừng
                                        </button>
                                    </div>
                                </td>
                            </tr>
                ...
                <div class="d-flex align-items-center justify-content-between mt-3">
                    <div class="text-muted">Danh sách phim của hệ thống</div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-12 col-md-6 mb-3">
                                            ...
                                            <input class="form-control" name="duration" placeholder="Ví dụ: 120 phút" />
                                        </div>
                                    </div>
                            ...
                            <div class="card shadow-sm">
                                <div class="card-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <img
                                            src="{{ asset('assets/movies/avatar.jpg') }}"
                                            alt="preview"
                                            style="width: 100%; height: 240px; object-fit: cover; border-radius: 8px; background:#eee;">
                                    </div>
                                    <div class="mb-2 text-muted small">Các field phân loại sẽ ở tab/section “Phân loại phim”.</div>
                                </div>
                            </div>
                            ...
                            <div class="card shadow-sm mt-3">
                                <div class="card-body">
                                    ...
                                    <div class="mb-2">
                                        ...
                                        <input class="form-control" name="actors" placeholder="Cách nhau bởi dấu phẩy" />
                                    </div>
                                    <div class="mb-0">
...
{{-- Modal: Cập nhật phim --}}
<div class="modal fade" id="movieUpdateModal" tabindex="-1" aria-labelledby="movieUpdateModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="movieUpdateModalLabel"><i class="bi bi-pencil-square"></i> Cập nhật phim</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            ...
            <form action="#" method="POST">
                        ...
                        <div class="col-12 col-lg-8">
                            <div class="card shadow-sm">
                                <div class="card-body">
                                    <div class="mb-3">
                                        <label class="form-label">Tên phim</label>
                                        <input class="form-control" name="title" value="" placeholder="Tên phim" />
                                    </div>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-outline-secondary" data-bs-dismiss="modal">Hủy</button>
                    <button type="submit" class="btn btn-primary"><i class="bi bi-save"></i> Cập nhật (demo)</button>
                </div>
            </form>
        </div>
    </div>
...
<div class="modal fade" id="movieClassifyModal" tabindex="-1" aria-labelledby="movieClassifyModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-scrollable">
        <div class="modal-content">
            ...
            <form action="#" method="POST">
                                ...
                                <div class="card-body">
                                    <div class="row g-3">
                                        <div class="col-12 mb-3">
                                            ...
                                            <input class="form-control" name="genre" placeholder="Ví dụ: Khoa học viễn tưởng" />
                                        </div>
                                        ...
                                        <div class="col-12 col-md-6 mb-3">
                                            ...
                                            <input class="form-control" name="language" placeholder="Ví dụ: Tiếng Anh" />
                                        </div>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-outline-secondary" data-bs-dismiss="modal">Hủy</button>
                    <button type="submit" class="btn btn-primary"><i class="bi bi-save"></i> Lưu phân loại (demo)</button>
                </div>
            </form>
        </div>
    </div>
...
<div class="modal fade" id="movieToggleModal" tabindex="-1" aria-labelledby="movieToggleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-md modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="movieToggleModalLabel"><i class="bi bi-eye-slash"></i> Ẩn / Ngừng chiếu (demo)</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            ...
            <form action="#" method="POST">
                <div class="modal-body">
                    <div class="alert alert-warning mb-3">
                        ...
                        <div class="small">Không xóa cứng phim đã có booking. Chỉ thay đổi trạng thái ẩn/ngừng chiếu.</div>
                    </div>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-outline-secondary" data-bs-dismiss="modal">Hủy</button>
                    <button type="submit" class="btn btn-warning"><i class="bi bi-check2-circle"></i> Thực hiện (demo)</button>
                </div>
            </form>
        </div>
    </div>
