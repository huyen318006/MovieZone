...
<div class="col-12">
    <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
        ...
        <div>
            <a href="{{ \App\Helpers\TabAuthHelper::route('admin.promotions.create') }}" class="btn btn-primary">
...
<div class="col-12 mt-3">
    <div class="card border-0 shadow-sm">
        <div class="card-header bg-transparent d-flex align-items-center justify-content-between flex-wrap gap-2">
            ...
            <form method="GET" action="{{ \App\Helpers\TabAuthHelper::route('admin.promotions.index') }}" class="d-flex gap-2 align-items-center">
                ...
                <a href="{{ \App\Helpers\TabAuthHelper::route('admin.promotions.index') }}" class="btn btn-outline-secondary btn-sm"><i class="bi bi-arrow-clockwise"></i></a>
            </form>
        </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex gap-2">
                                        <a href="{{ \App\Helpers\TabAuthHelper::route('admin.promotions.edit', $promo->id) }}" class="btn btn-outline-primary btn-sm">
                                            <i class="bi bi-pencil"></i> Sửa
                                        </a>
                                        <form method="POST" action="{{ \App\Helpers\TabAuthHelper::route('admin.promotions.destroy', $promo->id) }}" onsubmit="return confirm('Bạn có chắc chắn muốn xóa chương trình khuyến mãi này không?');" class="d-inline">
                                            @csrf
                                            @method('DELETE')
