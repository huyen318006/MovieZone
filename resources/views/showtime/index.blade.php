                        ...
                        <article class="showtime-card">
                            ...
                            <div class="showtime-card-body">
                                ...
                                <div class="showtime-card-meta">
                                    <span><i
                                            class="bi bi-door-open"></i>{{ $showtime->room?->name ?: 'Phòng đang cập nhật' }}</span>
                                    <span><i class="bi bi-clock"></i>{{ $startTime->format('H:i') }} -
                                        {{ $endTime->format('H:i') }}</span>
                                    <span><i class="bi bi-badge-3d"></i>{{ $showtime->format }} •
